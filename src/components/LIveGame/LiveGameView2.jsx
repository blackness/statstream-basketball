...
const LiveGameView = ({ 
  ...
  const handleOpponentQuickStat = async (statType, points = 0) => {
    ...
    // Update attempts for shooting stats
    if (statType === 'fgm') {
        ...
        <div className="space-y-4">
          ...
          {selectedPlayer && (
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 shadow-lg border-2 border-blue-300">
              ...
              <div className="mb-4">
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <button
                    ...
                    className="h-16 bg-red-600 hover:bg-red-700 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md"
                  >
                    FOUL
                  </button>
                  {activePlayers.includes(selectedPlayer) && team.roster?.filter(p => !activePlayers.includes(p.id)).length > 0 && (
                    <button
                      ...
                      className={`h-16 ${showSubPanel ? 'bg-orange-600 hover:bg-orange-700' : 'bg-orange-500 hover:bg-orange-600'} active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md`}
                    >
                      SUB
                    </button>
                  )}
              ...
              {/* Substitution Panel - Shown when SUB button clicked */}
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-2">
                <button
                  ...
                  className="h-14 bg-gray-600 hover:bg-gray-700 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md"
                >
                  OREB
                </button>
                <button
                  onClick={() => handleOpponentQuickStat('dreb', 0)}
                  className="h-14 bg-gray-500 hover:bg-gray-600 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md"
                >
                  DREB
                </button>
                <button
                  onClick={() => handleOpponentQuickStat('ast', 0)}
                  className="h-14 bg-yellow-600 hover:bg-yellow-700 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md"
                >
                  AST
                </button>
                <button
                  onClick={() => handleOpponentQuickStat('stl', 0)}
                  className="h-14 bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md"
                >
                  STL
                </button>
                <button
                  onClick={() => handleOpponentQuickStat('blk', 0)}
                  className="h-14 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md"
                >
                  BLK
                </button>
                <button
                  onClick={() => handleOpponentQuickStat('to', 0)}
                  className="h-14 bg-orange-600 hover:bg-orange-700 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md"
                >
                  TO
                </button>
                <button
                  onClick={() => handleOpponentQuickStat('pf', 0)}
                  className="h-14 bg-red-600 hover:bg-red-700 active:scale-95 text-white rounded-xl font-black text-sm transition-all shadow-md col-span-2"
                >
                  FOUL
                </button>
              </div>
